...
pub fn execute_generate(
    ...
    // Assemble manifest
    let header = "# Canon manifest — generated by `canon cluster generate`.\n\
                  # Edit the [config] section (pattern, query) and Notes freely.\n\
                  # The lock file tracks source identity; regenerate with `cluster refresh`.\n\
                  #\n";
