...
| 2 | Summary view (no filters) | Command module, CLI, selection pipeline, archive status, overlap with scope discovery, unique count, formatted output | Story 1 | Pending |
